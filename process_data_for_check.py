...
processed_data_path = "/data7/Users/lyx/code/mcts_dataset/data_for_check_25_4_15/1_processed_data" # 本次后处理完成的轨迹的目标文件夹
data_for_check_path = "/data7/Users/lyx/code/mcts_dataset/data_for_check_25_4_15/2_data_for_check" # 给人看的文件夹
            ...
            if end_index >= 3:
                ...
                for id in range(end_index):
                    ...
                    if id == 0:
                        ...
                        ui_action_summary_dic["action"] = json.dumps(action_json["action_list"][id-1])
